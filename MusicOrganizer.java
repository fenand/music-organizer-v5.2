...
public class MusicOrganizer
{
    ...
    // reproduccionen curso
    private boolean pistaEnReproduccion;
    ...
    public void playTrack(int index)
    {
        ...
        if(pistaEnReproduccion == false) {
            if(indexValid(index)) {
                Track track = tracks.get(index);
                player.startPlaying(track.getFilename());
                System.out.println("Now playing: " + track.getArtist() + " - " + track.getTitle());
                track.playCountIncremento();
                pistaEnReproduccion = true;
            }
        }
        else {
            System.out.println("ERROR!!!!: existe ya una reproduccion en curso");
        }
    }
    ...
    public void playFirst()
    {
        ...
        if(pistaEnReproduccion == false) {
            if(tracks.size() > 0) {
                ...
                tracks.get(0).playCountIncremento();
                pistaEnReproduccion = true;
            }
        }
        else {
            System.out.println("ERROR!!!!: existe una reproduccion en curso");
        }
    }
    ...
    public void isPlaying() {        
        if(pistaEnReproduccion == true) {
            System.out.println("Hay una canción reproduciéndose");                   
        }
        else {
            System.out.println("No hay ninguna canción en reproduccion");
        }
    }

    /**
     * Muestra los detalles de todos los traks 
    ...
    /**
     * Elimina canciones que contengan el artista 
